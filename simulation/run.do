...
vlog "+incdir+${PROJECT_DIR}/stimulus"  -work presynth "${PROJECT_DIR}/stimulus/tb_geig_data_handling.v"

vsim -L proasic3l -L presynth  -t 1ps presynth.tb_geig_data_handling
add wave /tb_geig_data_handling/*
run 1000ns
