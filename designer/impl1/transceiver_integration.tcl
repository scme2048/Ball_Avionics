...
# Wed Feb 24 18:08:05 2016

# (NEW DESIGN)

# create a new design
new_design -name "transceiver_integration" -family "ProASIC3L"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "transceiver_integration.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VERILOG" {../../synthesis/transceiver_integration.edn}

# save the design database
save_design {transceiver_integration.adb}
